module CFEConstants
  ...
  ASYLYM_PROCEEDING_TYPE_CCMS_CODE = :IA031
  IMMIGRATION_AND_ASYLUM_PROCEEDING_TYPE_CCMS_CODES = [IMMIGRATION_PROCEEDING_TYPE_CCMS_CODE, ASYLYM_PROCEEDING_TYPE_CCMS_CODE].freeze
