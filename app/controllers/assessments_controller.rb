class AssessmentsController < ApplicationController
  ...
  def self.documentation_for_get
    %(Get assessment result<br/>
       Version 4 of this api is currently valid.  The version is specified by the Accept header, for example</br>
       <tt>&nbsp;&nbsp;&nbsp;&nbsp;Accept:application/json;version=4</tt><br/>
       If the version part of the Accept header is not specified, version 4 is assumed
