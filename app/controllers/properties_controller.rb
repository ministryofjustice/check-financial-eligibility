class PropertiesController < ApplicationController
  ...
  param :properties, Object, desc: 'Describes information about the applicants property' do
    param :main_home, Object, desc: "The applicant's main home" do
      param :value, :currency, date_option: :today_or_older, required: true, desc: 'The value of this property'
      param :outstanding_mortgage, :currency, required: true, desc: 'The amount outstanding on any mortgage'
      param :percentage_owned, Number, require: true, desc: 'The percentage share of the property which is owned by the applicant'
