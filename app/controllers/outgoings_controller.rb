class OutgoingsController < ApplicationController
  ...
  param :outgoings, Array, desc: 'Collection of other regular income sources' do
    ...
    param :payments, Array, desc: 'Collection of payment dates and amounts' do
      param :payment_date, Date, date_option: :today_or_older, required: true, desc: 'The date payment received'
      param :housing_costs_type, %w[rent mortgage board_and_lodging], required: false, desc: 'The type of housing cost'
