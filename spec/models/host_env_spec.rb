...
RSpec.describe HostEnv do
  describe 'root_url' do
    it 'returns the root  url' do
      expect(HostEnv.root_url).to eq 'http://www.example.com/'
    end
  end
  ...
  context 'with dummied out root url' do
    ...
    context 'uat' do
      let(:root_url) { 'https://mybranch-uat.apps.live-1.cloud-platform.service.justice.gov.uk' }
    ...
    context 'staging' do
      let(:root_url) { 'check-financial-eligibility-staging.apps.live-1.cloud-platform.service.justice.gov.uk' }
      let(:rails_env) { :production }
    ...
    context 'production' do
      let(:root_url) { 'check-financial-eligibility.apps.live-1.cloud-platform.service.justice.gov.uk' }
      let(:rails_env) { :production }
