    ...
    describe '#call' do
      ...
      context '15 years old' do
        ...
        context 'with income greater than the allowance' do
          let(:dependant) { create :dependant, :aged_15, monthly_income: 250.00 }
          it 'returns zero' do
        ...
        context 'without income' do
          let(:dependant) { create :dependant, :aged_15, monthly_income: 30.55 }
          it 'returns the aged 15 allowance less the monthly income' do
      ...
      context '16 or 17 years old' do
        context 'in full time education' do
          ...
          context 'with income' do
            let(:dependant) { create :dependant, :aged_16_or_17, monthly_income: 100.01, in_full_time_education: true }
          ...
          context 'with income greater than the allowance' do
            let(:dependant) { create :dependant, :aged_16_or_17, monthly_income: 350.00, in_full_time_education: true }
            it 'returns zero' do
              expect(subject).to be_zero
            end
          end
        ...
        context 'not in full time education' do
          context 'with  no income' do
            let(:dependant) { create :dependant, :aged_16_or_17, monthly_income: 0.0, in_full_time_education: false }
          ...
          context 'with income' do
            let(:dependant) { create :dependant, :aged_16_or_17, monthly_income: 100.22, in_full_time_education: false }
            it 'returns the adult allowance with no income deduction' do
