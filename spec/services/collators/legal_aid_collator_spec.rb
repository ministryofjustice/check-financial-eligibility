    ...
    describe ".call" do
      ...
      context "when there are legal_aid outgoings" do
        before do
          ...
          create :legal_aid_outgoing, disposable_income_summary:, payment_date: 2.days.ago, amount: 103.46
          create :legal_aid_outgoing, disposable_income_summary:, payment_date: 30.days.ago, amount: 103.46
          create :legal_aid_outgoing, disposable_income_summary:, payment_date: 58.days.ago, amount: 103.46
