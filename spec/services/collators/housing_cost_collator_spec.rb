  ...
  RSpec.describe HousingCostsCollator do
    describe '.call' do
      ...
      context 'housing cost outgoings' do
        before do
          create :housing_cost_outgoing, disposable_income_summary: disposable_income_summary, amount: 355.44, payment_date: Date.today, housing_cost_type: housing_cost_type
        ...
        context 'housing benefit' do
          before do
            ...
            create :state_benefit_payment, state_benefit: state_benefit, amount: 101.02, payment_date: Date.today
