class ModifyAssessment < ActiveRecord::Migration[5.2]
  def change
    # rubocop:disable Rails/BulkChangeTable, Rails/ReversibleMigration, Rails/NotNullColumn
    ...
    # rubocop:enable Rails/BulkChangeTable, Rails/ReversibleMigration, Rails/NotNullColumn
  end
end
