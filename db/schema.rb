...
ActiveRecord::Schema.define(version: 20_210_114_115_829) do
  ...
  create_table 'cash_transaction_categories', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[gross_income_summary_id name operation], name: 'index_cash_transaction_categories_uniqueness', unique: true
  ...
  create_table 'irregular_income_payments', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[gross_income_summary_id income_type], name: 'irregular_income_payments_unique', unique: true
