Rswag::Ui.configure do |c|
  ...
  c.swagger_endpoint "/api-docs/v4/swagger.yaml", "API V4 Docs"
  c.swagger_endpoint "/api-docs/v3/swagger.yaml", "API V3 Docs"
  c.swagger_endpoint "/api-docs/v5/swagger.yaml", "API V5 Docs"
